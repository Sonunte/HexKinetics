...
package net.acrimoris.hexkinetics.common.casting
...
import net.acrimoris.hexkinetics.api.HexKineticsAPI.modLoc
import net.acrimoris.hexkinetics.common.casting.actions.*
import net.acrimoris.hexkinetics.common.casting.actions.great_spells.OpAcceleration
import net.acrimoris.hexkinetics.common.casting.actions.great_spells.OpMoveBlock
import net.acrimoris.hexkinetics.common.casting.actions.great_spells.OpZeroG
import net.acrimoris.hexkinetics.common.casting.actions.math.*
import net.acrimoris.hexkinetics.common.casting.actions.spells.*
