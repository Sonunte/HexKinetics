...
import net.acrimoris.hexkinetics.api.config.HexKineticsConfig;
import net.acrimoris.hexkinetics.xplat.IXplatAbstractions;
...
public class FabricYourModConfig extends PartitioningSerializer.GlobalData {
    ...
    private static class Server implements ConfigData, HexKineticsConfig.ServerConfigAccess {
        ...
        public boolean getMoveTileEntities() {
            return net.acrimoris.hexkinetics.fabric.FabricYourModConfig.Server.SettingsTranslocation.moveTileEntities;
        }
