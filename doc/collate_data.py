...
# TO USE (run from repo root):
# python doc/collate_data.py Common/src/main/resources doc/HexCastingResources hexkinetics hexkineticsbook doc/template.html doc/out.html
